export const projects = [
  {
    id: 1,
    title: "Graph Sampling for Scalable GNNs",
    description:
    ...
    outcomes: [
      "Published paper at EUSIPCO 2025",
      "Improved sampling efficiency by 40%",
      "Maintained model accuracy on large graphs",
    ],
  ...
  {
    id: 2,
    title: "Cancer Detection with CNNs",
    description:
    ...
    outcomes: [
      "Published paper at ICISCAE 2022",
      "Achieved 85% accuracy in detection",
  ...
  },
  {
    ...
    description:
      "Academic personal website built with React and modern web technologies. Features responsive design, blog functionality, and easy content management.",
    ...
    outcomes: [
      ...
      "Blog system with LaTeX support",
