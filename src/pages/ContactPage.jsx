      ...
      <div className="mt-16 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 border border-indigo-100">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Open to collaborative research projects in machine learning and
          ...
          <div className="text-center">
            ...
            <h4 className="font-medium text-gray-800 mb-2">Academic Writing</h4>
            <p className="text-sm text-gray-600">
              Interested in co-authoring papers and reviewing academic
              manuscripts
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="font-medium text-gray-800 mb-2">Mentoring</h4>
            <p className="text-sm text-gray-600">
              Available for mentoring students and early-career researchers
            </p>
          </div>
        </div>
      </div>
